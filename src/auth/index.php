...
<head>
    ...
    <script>
        function auth_popup(provider) {
            ...
            var authWindow = window.open('https://puzzleville.darkmarblecreative.com/auth/callback.php?provider=' + provider, 'authWindow', 'width=600,height=400,scrollbars=yes');
